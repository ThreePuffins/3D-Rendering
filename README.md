...
![image](3D_Renderer/examples/lines.png)
...
![image](3D_Renderer/examples/incomplete_puffin_wireframe.png)
...
![image](3D_Renderer/examples/triangles.png)
...
![image](3D_Renderer/examples/matrix_refactor.png)
...
![image](3D_Renderer/examples/pink_shaded.png)
...
![image](3D_Renderer/examples/diff_spec_glow_textured_demon.png)

Light depth buffer:
![image](3D_Renderer/examples/light_zbuffer.png)
...
## Usage
**Binaries will only run on macos silicon devices**
